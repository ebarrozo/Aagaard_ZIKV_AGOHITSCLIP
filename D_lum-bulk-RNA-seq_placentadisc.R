## lum-bulk-RNA-seq_placentadisc.R
...
setwd("/Users/enricobarrozo/Box/AagaardLab/Lum/results/v2/placentadisc")

#Manually change names from SRRXXXXXXXX.duprm.sorted.htseq.counts.txt to Mock_1.txt thru 4 and ZIKV 1 thru 7
## CD45(-) Mock_1.txt thru 4 and ZIKV 1 thru 7
# healthy ctrls: SRR10318591 SRR10318596 SRR10318597 SRR10318598
# patient 1: SRR10318605 SRR10318606 SRR10318607
# patient 2: SRR10318614 SRR10318615 SRR10318616
# patient 3: SRR10318621
## CD45+ :Mock_5.txt thru 8 and ZIKV 8 thru 14
# Healthy ctrls: SRR10318592 SRR10318599 SRR10318600 SRR10318601
# Patient 1: SRR10318608 SRR10318609 SRR10318610
# Patient 2: SRR10318617 SRR10318618 SRR10318619
# Patient 3: SRR10318622
...
df.merged <- temp[-c(1:22),]
#Change the column names to the sample IDs
colnames(df.merged)[c(2:23)] <- Names
...
mycount <- data.frame(df.merged[,c(1:23)])
row.names(mycount) <- mycount$gene
write.csv(mycount, file = "ZIKV_Mock_DESeq2_rawcounts.csv")
mycount$gene = NULL
...
sampleNames <- Names
condition <- c('Mock', 'Mock','Mock', 'Mock', 'Mock', 'Mock', 'Mock', 'Mock', 'ZIKV', 'ZIKV', 'ZIKV', 'ZIKV', 'ZIKV', 'ZIKV', 'ZIKV',  'ZIKV', 'ZIKV', 'ZIKV', 'ZIKV', 'ZIKV', 'ZIKV', 'ZIKV')
