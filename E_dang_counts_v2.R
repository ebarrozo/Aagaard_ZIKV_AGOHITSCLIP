...
setwd("/Users/enricobarrozo/Box/AagaardLab/dang/results/counts_v2/agoclip")
...
mycount$gene = NULL
write.csv(mycount, file = "ZIKV_Mock_agoclip-dang_rawcounts.csv")
...
sampleNames <- Names
condition <- c('Mock', 'Mock','Mock','ZIKV', 'ZIKV', 'ZIKV')
